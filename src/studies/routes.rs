...
/// transposition, add-line (#173) and merge-danger (#177) routes — each split
/// into their own file for the same over-cap reason as `danger_route.rs` —
/// can all reuse the same response shape.
#[derive(Serialize)]
