...
import { parseUci, uciLineToSan } from './pv'
...
describe('parseUci', () => {
  ...
  it('rejects junk', () => {
    ...
    expect(parseUci(null as unknown as string)).toBeNull()
  })
})
...
describe('uciLineToSan', () => {
  ...
  it('returns [] for an invalid FEN or non-array pv', () => {
    ...
    expect(uciLineToSan(STARTPOS_FEN, null as unknown as string[])).toEqual([])
  })
})
